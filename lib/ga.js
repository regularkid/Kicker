...
GA.create = function(width, height, setup, assetsToLoad, load) {
  ...
  */
  ...
  // RegularKid Modification: Attach canvas to "game" div rather than root of page
  div = document.getElementById("game");
  div.appendChild(ga.canvas);
  ...
  */
  ...
  ga.text = function(content, font, fillStyle, x, y) {
    ...
    o.render = function(ctx) {
      ...
      // RegularKid Modification: alignment
  ...
  ga.sprite = function(source) {
    ...
    o.render = function(ctx) {
      ...
      // RegularKid Modification: Disable sprite smooth scaling by default
...
// RegularKid Modification: Renamed "ga" to "gaEngine" to avoid conflict with Google Analytics "ga" object.
window.gaEngine = GA.create;
